...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ top__DOT__cpu__DOT__control_output;
    ...
    struct {
        ...
        CData/*7:0*/ top__DOT__cpu__DOT__control_signal__DOT__D0;
        CData/*7:0*/ top__DOT__cpu__DOT__control_signal__DOT__D1;
        CData/*7:0*/ top__DOT__cpu__DOT__control_signal__DOT__Y;
    ...
    static constexpr IData/*31:0*/ top__DOT__cpu__DOT__control_signal__DOT__data_width = 8U;
