...
VL_INLINE_OPT void Vvending_machine___024root___nba_sequent__TOP__0(Vvending_machine___024root* vlSelf) {
    ...
    // Init
    CData/*2:0*/ __Vdly__vending_machine__DOT__statea;
    __Vdly__vending_machine__DOT__statea = 0;
    IData/*31:0*/ __Vdly__vending_machine__DOT__wait_time;
    __Vdly__vending_machine__DOT__wait_time = 0;
    // Body
    __Vdly__vending_machine__DOT__statea = vlSelf->vending_machine__DOT__statea;
    ...
    if (((IData)(vlSelf->i_trigger_return) & (0U == (IData)(vlSelf->vending_machine__DOT__statea)))) {
        __Vdly__vending_machine__DOT__statea = 1U;
    } else if ((1U == (IData)(vlSelf->vending_machine__DOT__statea))) {
        __Vdly__vending_machine__DOT__statea = 2U;
    } else if ((2U == (IData)(vlSelf->vending_machine__DOT__statea))) {
        __Vdly__vending_machine__DOT__statea = 3U;
    } else if ((3U == (IData)(vlSelf->vending_machine__DOT__statea))) {
        if (vlSelf->i_trigger_return) {
            vlSelf->vending_machine__DOT__current_total 
                = (vlSelf->vending_machine__DOT__current_total_nxt 
                   - vlSelf->vending_machine__DOT__return_total);
        } else {
            __Vdly__vending_machine__DOT__statea = 4U;
        }
    } else {
        __Vdly__vending_machine__DOT__statea = 0U;
    }
    vlSelf->vending_machine__DOT__wait_time = __Vdly__vending_machine__DOT__wait_time;
    vlSelf->vending_machine__DOT__statea = __Vdly__vending_machine__DOT__statea;
